  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[var(--color-ink)] rounded-3xl sm:rounded-[2.5rem] p-8 sm:p-12 text-white relative overflow-hidden shadow-2xl border border-brand-dark/40">
          {/* Subtle background glow */}
          <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-[var(--color-brand)]/15 blur-3xl pointer-events-none" />

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--color-brand)]/20 text-[var(--color-brand-bright)] text-xs font-bold">
              ...
              <div className="flex items-center gap-4 pt-2 text-xs text-gray-400">
                <div className="flex items-center gap-1 text-[var(--color-brand-bright)] font-bold">
                  <Star className="w-4 h-4 fill-[var(--color-brand-bright)]" />
                  <span>4.9 / 5</span>
                </div>
                <span>•</span>
            ...
            <div className="lg:col-span-4 flex justify-center">
              <div className="bg-white p-5 rounded-3xl shadow-xl text-center text-gray-900 border border-brand-light max-w-xs">
