      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xs text-center flex flex-col items-center">
            <div className="w-12 h-12 rounded-2xl bg-[var(--color-brand-light)] text-[var(--color-brand)] flex items-center justify-center mb-4">
            ...
            <a
              ...
              className="text-xs font-bold text-[var(--color-brand-hover)] bg-[var(--color-brand-light)] px-4 py-2 rounded-xl hover:bg-[var(--color-brand-light)] transition-colors"
            >
              1800-420-ASSIST
            </a>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xs text-center flex flex-col items-center">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-xs font-bold text-brand-hover bg-brand-soft px-4 py-2 rounded-xl hover:bg-brand-light transition-colors"
            >
              Chat on WhatsApp
            </a>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xs text-center flex flex-col items-center">
            <div className="w-12 h-12 rounded-2xl bg-brand-soft text-[var(--color-brand)] flex items-center justify-center mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-3xl border border-gray-100 shadow-xs">
            ...
            {submittedTicket && (
              <div className="mb-6 p-4 bg-brand-soft border border-line rounded-2xl text-xs text-brand-dark flex items-center gap-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-[var(--color-brand)]"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-[var(--color-brand)] cursor-pointer"
                >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-3 bg-[var(--color-brand)] hover:bg-[var(--color-brand-hover)] text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer shadow-brand/20"
              >
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-[var(--color-ink)] to-[var(--color-ink)] text-white p-6 sm:p-8 rounded-3xl shadow-lg space-y-4 border border-brand/20">
            <div className="w-12 h-12 rounded-2xl bg-brand/20 border border-brand/30 flex items-center justify-center text-[var(--color-brand-bright)]">
